...
// if(count($resStd)==0)
// {
//   echo "<script>alert('Please Give Proper Details...!');location.href='verification_copy.php'</script>";
// }
...
$qryStd="select * from ".$table1." where (randomId ='$a') order by id desc";
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <input type="text" name="local_details" id="local_details" class="form-control" value="<?php echo $stdlocal_details;?>"readonly required>
              </div>
